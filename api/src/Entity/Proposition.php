...
class Proposition
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column()]
    #[Groups(["project_get_propositions", "proposition_get", "proposition_cget", "user_get_propositions", 'user_admin_get'])]
    private ?int $id = null;
    ...
    #[Groups(["proposition_get", "proposition_cget", "user_get_propositions", 'user_admin_get'])]
